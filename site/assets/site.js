...
const translations = {
  zh: {
    ...
    manifestFileError: "无法从 file:// 读取固件。请按 README 使用本地 HTTP 服务预览。",
  ...
  en: {
    ...
    manifestFileError: "Firmware cannot be loaded from file://. Use the local HTTP preview described in the README.",
