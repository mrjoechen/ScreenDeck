...
const translations={
  zh:{
    ...
    displayKicker:"08 / 显示设置",brightnessTitle:"屏幕亮度",brightnessBody:"拖动即可实时调节背光，松手保存到设备。",interfaceLanguage:"界面语言",contentStorage:"内容存储",networkKicker:"09 / 网络设置",networkBody:"清除已保存的网络后，设备会重启并重新显示配网二维码。",resetWifi:"清除 Wi-Fi 并重启",footer:"仅限本地 · 无云端 · 设置保存在此设备",
